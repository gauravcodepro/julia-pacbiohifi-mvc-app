...
# !!! Main.UserApp is configured as an alias for Main.PacbioView and you might encounter it in some tests
using Main.PacbioView, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "PacbioView tests" begin
  @includetests ARGS
end
